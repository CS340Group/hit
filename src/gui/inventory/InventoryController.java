...
//		this.addSampleItems();
    ...
    /*
      ...
      */
    private ProductContainerData addChildrenProductContainers(ProductContainer pc,
    ...
    public void productContainerSelectionChanged() {
        ...
        if (selectedContainerData != null) {
            ...
            if (selectedStorageUnit != null) {
                products = (List) _mf.productVault
                        .findAll("ContainerId = %o", selectedStorageUnit.getId());
                ...
                products = (List) _mf.productVault
                        .findAll("ContainerId = %o", selectedProductGroup.getId());
    ...
    public void addProductToContainer(ProductData productData,
        ...
        this.currentlySelectedPCId = id;
        if (selectedProductGroup != null) {
            _mf.dragProduct(selectedProductGroup.getStorageUnit(), selectedProductGroup,
                    selectedProduct);
        } else {
