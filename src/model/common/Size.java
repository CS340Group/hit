...
public class Size implements Serializable {
    ...
    public Result validate() {
        ...
        if (_unit.toLowerCase().contentEquals("count") && _amount != Math.round(_amount)) {
            ...
            //TODO:I commented this out because product groups can have a \
            // 3month supply with a count > 1 - Brendon Beebe (11/7/2012)
    ...
    */
    public String getSizeType() {
        ...
        if (unit.equals("count"))
            return "count";
        else if (unit.equals("pounds") || unit.equals("ounces") || unit.equals("grams") ||
                unit.equals("kilograms"))
            return "weight";
        else if (unit.equals("gallons") || unit.equals("quarts") || unit.equals("fluid ounces") ||
                unit.equals("liters") || unit.equals("pints"))
            return "volume";
        else return "unknown";
    }
