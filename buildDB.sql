...
CREATE TABLE "product" ("id" INTEGER , "storageUnitId" INTEGER, "parentId" INTEGER, "barcode" TEXT, "MonthSupply" INTEGER, "sizeAmount" FLOAT, "sizeUnit" TEXT, "deleted" BOOL, "description" TEXT, "shelfLife" INTEGER, "creationDate" LONG);
