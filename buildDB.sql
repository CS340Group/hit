...
CREATE TABLE IF NOT EXISTS "productGroup" ("id" INTEGER, "name" TEXT, "rootParentId" INTEGER, "parentId" INTEGER, "MonthSupplyAmount" FLOAT, "MonthSupplyUnit" TEXT, "deleted" BOOL);
